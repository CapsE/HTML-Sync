...
module.exports = function(HTMLSync){
     ...
     */
    Syncable.prototype.update = function (fields, send) {
        if (!fields.key) {
    ...
    Syncable.prototype.on = function (attribute, value) {
        this.addEventHandler(attribute, value);
    };
    Syncable.prototype.addEventHandler = function (attribute, value) {
     ...
     */
    Syncable.prototype.prepareFunction = function (func) {
        var f = func.toString();
        var m;
        while (m = /this/.exec(f)) {
    ...
    Syncable.prototype.call = function (func, e) {
        var result = [];
    ...
    Syncable.prototype.kill = function () {
    ...
    Syncable.prototype.lock = function () {
        var fields = {
            id: this.id,
    ...
    Syncable.prototype.unlock = function () {
        var fields = {
            id: this.id,
            roomId: HTMLSync.room,
            locked: false
